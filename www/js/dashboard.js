...
$.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/dashnewveri.php?region='+region,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/dashinprogress.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/dashverified.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/dash_not_verified.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/completed.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#newt').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
if(gcm_regidexi != gcm_regid ){
 $.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/gcm_id.php?gcm_regid='+gcm_regid+"&E_Mail="+E_Mail+"&username="+username+"&region="+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
