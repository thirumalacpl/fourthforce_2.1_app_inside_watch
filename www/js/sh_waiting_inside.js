...
$.ajax({url: "http://staging.eimpressive.com/watchguardlive/slim-four/accept_or_reject.php?accept="+accept+"&verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&region="+region,
...
alert(reject);
document.getElementById('waiting_approve').value = "";
$.ajax({url: "http://staging.eimpressive.com/watchguardlive/slim-four/reject_sh.php?reject="+reject+"&verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&region="+region,
    data:$('#accept_or_reject').serialize(),
    type: 'post',                   
    async: 'true',
    crossDomain: true,
