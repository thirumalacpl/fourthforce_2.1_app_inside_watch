...
//$.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/dashinprogress.php?region='+region+"&user_id="+user_id,
//alert(region);
//alert(user_id);
$.ajax({url: 'http://staging.eimpressive.com/watchguardlive/slim-four/count.php?region='+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/watchguardlive/slim-four/lifeint.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&qualification_id="+qualification_id+"&inte="+inte+"&inte_rat="+inte_rat+"&beh="+beh+"&beh_rat="+beh_rat+"&hab="+hab+"&hab_rat="+hab_rat,
