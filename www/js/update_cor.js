...
$.ajax({
  type: "POST",
  url: "http://staging.eimpressive.com/watchguardlive/slim-four/chat_cor.php?loginistant="+loginistant+"&verification_user_id="+verification_user_id+"&qualification_id="+qualification_id,
